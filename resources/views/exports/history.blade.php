...
@section('content')
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ session('back_to_job_posts_url', route('job-posts.index')) }}" class="btn btn-outline-secondary">Quay
                lại danh sách</a>
        </div>
            ...
            <div class="card-body p-0">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-4 text-muted">Bạn chưa có lịch sử xuất file nào.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                            ...
                            if (row) {
                                ...
                                if (currentStatus !== log.status) {
                                    ...
                                    if (log.status === 'completed') {
                                        ...
                                        Toastify({
                                            text: "Một tệp đã xuất thành công!",
                                            duration: 4000,
                                            style: {
                                                background: "#198754"
                                            }
                                        ...
                                        statusCol.innerHTML =
                                            '<span class="badge bg-danger">Thất bại</span>';
                                        actionCol.innerHTML =
                                            `<button class="btn btn-sm btn-danger btn-show-error" data-error="${log.error_message}"><i class="bi bi-exclamation-triangle me-1"></i> Xem lỗi</button>`;
