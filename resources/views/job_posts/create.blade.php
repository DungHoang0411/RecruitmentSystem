...
<div class="container mt-4 mb-5">
    ...
    <form action="{{ route('job-posts.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="destination_country" class="form-control @error('destination_country') is-invalid @enderror" placeholder="VD: JP, KR" value="{{ old('destination_country') }}" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Số lượng tuyển <span class="text-danger">*</span></label>
                        <input type="number" name="headcount" class="form-control @error('headcount') is-invalid @enderror" min="1" value="{{ old('headcount', 1) }}" required>
                    </div>
                    <div class="col-md-3 mb-3">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="visa_type" class="form-select" required>
                            ...
                            <option value="ginou_jisshu" {{ old('visa_type') == 'ginou_jisshu' ? 'selected' : '' }}>Ginou Jisshu</option>
        ...
        {{-- NHÓM 2: MỨC LƯƠNG & ĐỊA ĐIỂM (TÙY CHỌN) --}}
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="work_location" class="form-control" value="{{ old('work_location') }}" placeholder="VD: Tokyo, Nhật Bản">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Lương tối thiểu</label>
                        <input type="number" name="salary_min" class="form-control" value="{{ old('salary_min') }}" placeholder="VD: 150000">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Lương tối đa</label>
                        <input type="number" name="salary_max" class="form-control" value="{{ old('salary_max') }}" placeholder="VD: 250000">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Đơn vị tiền tệ</label>
                        <select name="salary_currency" class="form-select">
                            <option value="">-- Chọn --</option>
                            <option value="JPY" {{ old('salary_currency') == 'JPY' ? 'selected' : '' }}>Yên Nhật (JPY)</option>
                            <option value="KRW" {{ old('salary_currency') == 'KRW' ? 'selected' : '' }}>Won (KRW)</option>
                            <option value="USD" {{ old('salary_currency') == 'USD' ? 'selected' : '' }}>USD</option>
                            <option value="VND" {{ old('salary_currency') == 'VND' ? 'selected' : '' }}>VNĐ</option>
                        </select>
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="salary_period" class="form-select">
                            <option value="">-- Chọn --</option>
                            <option value="monthly" {{ old('salary_period') == 'monthly' ? 'selected' : '' }}>Hàng tháng</option>
                            <option value="hourly" {{ old('salary_period') == 'hourly' ? 'selected' : '' }}>Theo giờ</option>
                            <option value="yearly" {{ old('salary_period') == 'yearly' ? 'selected' : '' }}>Hàng năm</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        {{-- NHÓM 3: YÊU CẦU & PHÚC LỢI (TÙY CHỌN) --}}
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="age_min" class="form-control" placeholder="Từ" value="{{ old('age_min') }}">
                            <span class="input-group-text">-</span>
                            <input type="number" name="age_max" class="form-control" placeholder="Đến" value="{{ old('age_max') }}">
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label">Yêu cầu công việc (Chi tiết)</label>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="status" class="form-select" required>
                            ...
                            <option value="published" {{ old('status') == 'published' ? 'selected' : '' }}>Hiển thị (Đăng tin)</option>
                            <option value="closed" {{ old('status') == 'closed' ? 'selected' : '' }}>Đóng tuyển dụng</option>
                        </select>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Ngày bắt đầu đăng (Tùy chọn)</label>
        ...
        <div class="text-end">
            <button type="submit" class="btn btn-primary btn-lg px-5">Lưu Tin Tuyển Dụng</button>
        </div>
    </form>
</div>
@endsection