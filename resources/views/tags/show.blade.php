...
@section('content')
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <a href="{{ route('tags.index') }}" class="text-decoration-none text-muted mb-2 d-inline-block"><i
                        class="bi bi-arrow-left"></i> Quay lại</a>
                <h3 class="fw-bold text-dark mb-0">Việc làm liên quan tới: <span
                        class="brand-text">#{{ $tag->name }}</span></h3>
            </div>
        </div>
        ...
        <div class="row g-4 mt-2">
                    ...
                    <div class="job-card">
                        ...
                        <div class="job-card__body">
                            <div class="text-muted mb-2 fw-medium">
                                <i class="bi bi-buildings me-2"></i> {{ $item->company->name ?? 'Công ty đối tác bảo mật' }}
                            </div>
                        </div>
                        ...
                        <div class="job-card__footer">
                            ...
                            <a href="{{ route('job-posts.show', $item->slug) }}" class="btn btn-sm btn-brand px-3">Chi
                                tiết</a>
                        </div>
                    </div>
                </div>
            @empty
                <div class="col-12 text-center py-5">
                    <h5 class="text-muted">Chưa có tin tuyển dụng nào được gắn thẻ này.</h5>
                </div>
            @endforelse
        </div>
